  ...
  try {
    ...
    const formattedBookings = bookings.map(booking => {
      ...
      return {
        ...
        remaining_cash_amount: booking.remaining_cash_amount,
        remaining_online_amount: booking.remaining_online_amount,
        remaining_online_method: booking.remaining_online_method,
